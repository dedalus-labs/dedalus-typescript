...
import { ClientOptions } from 'dedalus';
...
export { ClientOptions } from 'dedalus';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/dedalus',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the dedalus MCP server. You will use Code Mode to help the user perform
