...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    perLanguage: {
      cli: {
        ...
        example: "dedalus workspaces list \\\n  --api-key 'My API Key'",
      },
      go: {
      ...
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      typescript: {
        method: 'client.workspaces.create',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst workspace = await client.workspaces.create({\n  memory_mib: 0,\n  storage_gib: 0,\n  vcpu: 0,\n});\n\nconsole.log(workspace.workspace_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        method: 'workspaces retrieve',
        example: "dedalus workspaces retrieve \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id",
      },
      go: {
        method: 'client.Workspaces.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tworkspace, err := client.Workspaces.Get(context.TODO(), "workspace_id")\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", workspace.WorkspaceID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.retrieve',
        example:
      ...
      typescript: {
        method: 'client.workspaces.retrieve',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst workspace = await client.workspaces.retrieve('workspace_id');\n\nconsole.log(workspace.workspace_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces update \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --if-match If-Match",
      },
      go: {
        method: 'client.Workspaces.Update',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tworkspace, err := client.Workspaces.Update(\n\t\tcontext.TODO(),\n\t\t"workspace_id",\n\t\tdedalus.WorkspaceUpdateParams{\n\t\t\tUpdateParams: dedalus.UpdateParams{},\n\t\t\tIfMatch:      "If-Match",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", workspace.WorkspaceID)\n}\n',
      },
      http: {
        example:
          "curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\" \\\n    -d '{}'",
  ...
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces delete \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --if-match If-Match",
      },
      go: {
        method: 'client.Workspaces.Delete',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tworkspace, err := client.Workspaces.Delete(\n\t\tcontext.TODO(),\n\t\t"workspace_id",\n\t\tdedalus.WorkspaceDeleteParams{\n\t\t\tIfMatch: "If-Match",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", workspace.WorkspaceID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID \\\n    -X DELETE \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
  ...
  },
  {
    ...
    perLanguage: {
      cli: {
        method: 'workspaces watch',
        example: "dedalus workspaces watch \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id",
      },
      go: {
        method: 'client.Workspaces.Watch',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tstream := client.Workspaces.WatchStreaming(\n\t\tcontext.TODO(),\n\t\t"workspace_id",\n\t\tdedalus.WorkspaceWatchParams{},\n\t)\n\tfor stream.Next() {\n\t\tfmt.Printf("%+v\\n", stream.Current())\n\t}\n\terr := stream.Err()\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/status/stream \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.watch',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\nfor workspace in client.workspaces.watch(\n    workspace_id="workspace_id",\n):\n  print(workspace)',
      },
      typescript: {
        method: 'client.workspaces.watch',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst workspace = await client.workspaces.watch('workspace_id');\n\nconsole.log(workspace.workspace_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:artifacts list \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id",
      },
      go: {
        method: 'client.Workspaces.Artifacts.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpage, err := client.Workspaces.Artifacts.List(\n\t\tcontext.TODO(),\n\t\t"workspace_id",\n\t\tdedalus.WorkspaceArtifactListParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/artifacts \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.artifacts.list',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\npage = client.workspaces.artifacts.list(\n    workspace_id="workspace_id",\n)\npage = page.items[0]\nprint(page.artifact_id)',
      },
      typescript: {
        method: 'client.workspaces.artifacts.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:artifacts retrieve \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --artifact-id artifact_id",
      },
      go: {
        method: 'client.Workspaces.Artifacts.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tartifact, err := client.Workspaces.Artifacts.Get(\n\t\tcontext.TODO(),\n\t\t"artifact_id",\n\t\tdedalus.WorkspaceArtifactGetParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", artifact.ArtifactID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/artifacts/$ARTIFACT_ID \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.artifacts.retrieve',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\nartifact = client.workspaces.artifacts.retrieve(\n    artifact_id="artifact_id",\n    workspace_id="workspace_id",\n)\nprint(artifact.artifact_id)',
      },
      typescript: {
        method: 'client.workspaces.artifacts.retrieve',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst artifact = await client.workspaces.artifacts.retrieve('artifact_id', {\n  workspace_id: 'workspace_id',\n});\n\nconsole.log(artifact.artifact_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:artifacts delete \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --artifact-id artifact_id",
      },
      go: {
        method: 'client.Workspaces.Artifacts.Delete',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tartifact, err := client.Workspaces.Artifacts.Delete(\n\t\tcontext.TODO(),\n\t\t"artifact_id",\n\t\tdedalus.WorkspaceArtifactDeleteParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", artifact.ArtifactID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/artifacts/$ARTIFACT_ID \\\n    -X DELETE \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      ...
      python: {
        method: 'workspaces.artifacts.delete',
        example:
      ...
      typescript: {
        method: 'client.workspaces.artifacts.delete',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst artifact = await client.workspaces.artifacts.delete('artifact_id', {\n  workspace_id: 'workspace_id',\n});\n\nconsole.log(artifact.artifact_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:previews list \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id",
      },
      go: {
        method: 'client.Workspaces.Previews.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpage, err := client.Workspaces.Previews.List(\n\t\tcontext.TODO(),\n\t\t"workspace_id",\n\t\tdedalus.WorkspacePreviewListParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/previews \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.previews.list',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\npage = client.workspaces.previews.list(\n    workspace_id="workspace_id",\n)\npage = page.items[0]\nprint(page.preview_id)',
      },
      typescript: {
        method: 'client.workspaces.previews.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:previews create \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --port 0",
      },
      go: {
        method: 'client.Workspaces.Previews.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpreview, err := client.Workspaces.Previews.New(\n\t\tcontext.TODO(),\n\t\t"workspace_id",\n\t\tdedalus.WorkspacePreviewNewParams{\n\t\t\tPreviewCreateParams: dedalus.PreviewCreateParams{\n\t\t\t\tPort: 0,\n\t\t\t},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", preview.PreviewID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/previews \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY" \\\n    -d \'{\n          "port": 0\n        }\'',
      ...
      python: {
        method: 'workspaces.previews.create',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\npreview = client.workspaces.previews.create(\n    workspace_id="workspace_id",\n    port=0,\n)\nprint(preview.preview_id)',
      },
      typescript: {
        method: 'client.workspaces.previews.create',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst preview = await client.workspaces.previews.create('workspace_id', { port: 0 });\n\nconsole.log(preview.preview_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:previews retrieve \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --preview-id preview_id",
      },
      go: {
        method: 'client.Workspaces.Previews.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpreview, err := client.Workspaces.Previews.Get(\n\t\tcontext.TODO(),\n\t\t"preview_id",\n\t\tdedalus.WorkspacePreviewGetParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", preview.PreviewID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/previews/$PREVIEW_ID \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.previews.retrieve',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\npreview = client.workspaces.previews.retrieve(\n    preview_id="preview_id",\n    workspace_id="workspace_id",\n)\nprint(preview.preview_id)',
      },
      typescript: {
        method: 'client.workspaces.previews.retrieve',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst preview = await client.workspaces.previews.retrieve('preview_id', {\n  workspace_id: 'workspace_id',\n});\n\nconsole.log(preview.preview_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:previews delete \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --preview-id preview_id",
      },
      go: {
        method: 'client.Workspaces.Previews.Delete',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpreview, err := client.Workspaces.Previews.Delete(\n\t\tcontext.TODO(),\n\t\t"preview_id",\n\t\tdedalus.WorkspacePreviewDeleteParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", preview.PreviewID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/previews/$PREVIEW_ID \\\n    -X DELETE \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      ...
      python: {
        method: 'workspaces.previews.delete',
        example:
      ...
      typescript: {
        method: 'client.workspaces.previews.delete',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst preview = await client.workspaces.previews.delete('preview_id', {\n  workspace_id: 'workspace_id',\n});\n\nconsole.log(preview.preview_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        method: 'ssh list',
        example: "dedalus workspaces:ssh list \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id",
      },
      go: {
        method: 'client.Workspaces.SSH.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpage, err := client.Workspaces.SSH.List(\n\t\tcontext.TODO(),\n\t\t"workspace_id",\n\t\tdedalus.WorkspaceSSHListParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/ssh \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.ssh.list',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\npage = client.workspaces.ssh.list(\n    workspace_id="workspace_id",\n)\npage = page.items[0]\nprint(page.session_id)',
      },
      typescript: {
        method: 'client.workspaces.ssh.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      python: {
        method: 'workspaces.ssh.create',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\nssh_session = client.workspaces.ssh.create(\n    workspace_id="workspace_id",\n    public_key="public_key",\n)\nprint(ssh_session.session_id)',
      },
      typescript: {
        method: 'client.workspaces.ssh.create',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst sshSession = await client.workspaces.ssh.create('workspace_id', { public_key: 'public_key' });\n\nconsole.log(sshSession.session_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        method: 'ssh retrieve',
        example:
          "dedalus workspaces:ssh retrieve \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --session-id session_id",
      },
      go: {
        method: 'client.Workspaces.SSH.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tsshSession, err := client.Workspaces.SSH.Get(\n\t\tcontext.TODO(),\n\t\t"session_id",\n\t\tdedalus.WorkspaceSSHGetParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", sshSession.SessionID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/ssh/$SESSION_ID \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.ssh.retrieve',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\nssh_session = client.workspaces.ssh.retrieve(\n    session_id="session_id",\n    workspace_id="workspace_id",\n)\nprint(ssh_session.session_id)',
      },
      typescript: {
        method: 'client.workspaces.ssh.retrieve',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst sshSession = await client.workspaces.ssh.retrieve('session_id', {\n  workspace_id: 'workspace_id',\n});\n\nconsole.log(sshSession.session_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        method: 'ssh delete',
        example:
          "dedalus workspaces:ssh delete \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --session-id session_id",
      },
      go: {
        method: 'client.Workspaces.SSH.Delete',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tsshSession, err := client.Workspaces.SSH.Delete(\n\t\tcontext.TODO(),\n\t\t"session_id",\n\t\tdedalus.WorkspaceSSHDeleteParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", sshSession.SessionID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/ssh/$SESSION_ID \\\n    -X DELETE \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      ...
      python: {
        method: 'workspaces.ssh.delete',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\nssh_session = client.workspaces.ssh.delete(\n    session_id="session_id",\n    workspace_id="workspace_id",\n)\nprint(ssh_session.session_id)',
      },
      typescript: {
        method: 'client.workspaces.ssh.delete',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst sshSession = await client.workspaces.ssh.delete('session_id', {\n  workspace_id: 'workspace_id',\n});\n\nconsole.log(sshSession.session_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:executions list \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id",
      },
      go: {
        method: 'client.Workspaces.Executions.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpage, err := client.Workspaces.Executions.List(\n\t\tcontext.TODO(),\n\t\t"workspace_id",\n\t\tdedalus.WorkspaceExecutionListParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/executions \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.executions.list',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\npage = client.workspaces.executions.list(\n    workspace_id="workspace_id",\n)\npage = page.items[0]\nprint(page.execution_id)',
      },
      typescript: {
        method: 'client.workspaces.executions.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:executions create \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --command string",
      },
      go: {
        method: 'client.Workspaces.Executions.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\texecution, err := client.Workspaces.Executions.New(\n\t\tcontext.TODO(),\n\t\t"workspace_id",\n\t\tdedalus.WorkspaceExecutionNewParams{\n\t\t\tExecutionCreateParams: dedalus.ExecutionCreateParams{\n\t\t\t\tCommand: []string{"string"},\n\t\t\t},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", execution.ExecutionID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/executions \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY" \\\n    -d \'{\n          "command": [\n            "string"\n          ]\n        }\'',
      ...
      python: {
        method: 'workspaces.executions.create',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\nexecution = client.workspaces.executions.create(\n    workspace_id="workspace_id",\n    command=["string"],\n)\nprint(execution.execution_id)',
      },
      typescript: {
        method: 'client.workspaces.executions.create',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst execution = await client.workspaces.executions.create('workspace_id', {\n  command: ['string'],\n});\n\nconsole.log(execution.execution_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:executions retrieve \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --execution-id execution_id",
      },
      go: {
        method: 'client.Workspaces.Executions.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\texecution, err := client.Workspaces.Executions.Get(\n\t\tcontext.TODO(),\n\t\t"execution_id",\n\t\tdedalus.WorkspaceExecutionGetParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", execution.ExecutionID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/executions/$EXECUTION_ID \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.executions.retrieve',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\nexecution = client.workspaces.executions.retrieve(\n    execution_id="execution_id",\n    workspace_id="workspace_id",\n)\nprint(execution.execution_id)',
      },
      typescript: {
        method: 'client.workspaces.executions.retrieve',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst execution = await client.workspaces.executions.retrieve('execution_id', {\n  workspace_id: 'workspace_id',\n});\n\nconsole.log(execution.execution_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:executions delete \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --execution-id execution_id",
      },
      go: {
        method: 'client.Workspaces.Executions.Delete',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\texecution, err := client.Workspaces.Executions.Delete(\n\t\tcontext.TODO(),\n\t\t"execution_id",\n\t\tdedalus.WorkspaceExecutionDeleteParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", execution.ExecutionID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/executions/$EXECUTION_ID \\\n    -X DELETE \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      ...
      python: {
        method: 'workspaces.executions.delete',
        example:
      ...
      typescript: {
        method: 'client.workspaces.executions.delete',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst execution = await client.workspaces.executions.delete('execution_id', {\n  workspace_id: 'workspace_id',\n});\n\nconsole.log(execution.execution_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:executions output \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --execution-id execution_id",
      },
      go: {
        method: 'client.Workspaces.Executions.Output',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\texecutionOutput, err := client.Workspaces.Executions.Output(\n\t\tcontext.TODO(),\n\t\t"execution_id",\n\t\tdedalus.WorkspaceExecutionOutputParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", executionOutput.ExecutionID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/executions/$EXECUTION_ID/output \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.executions.output',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\nexecution_output = client.workspaces.executions.output(\n    execution_id="execution_id",\n    workspace_id="workspace_id",\n)\nprint(execution_output.execution_id)',
      },
      typescript: {
        method: 'client.workspaces.executions.output',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst executionOutput = await client.workspaces.executions.output('execution_id', {\n  workspace_id: 'workspace_id',\n});\n\nconsole.log(executionOutput.execution_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:executions events \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --execution-id execution_id",
      },
      go: {
        method: 'client.Workspaces.Executions.Events',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpage, err := client.Workspaces.Executions.Events(\n\t\tcontext.TODO(),\n\t\t"execution_id",\n\t\tdedalus.WorkspaceExecutionEventsParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/executions/$EXECUTION_ID/events \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.executions.events',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\npage = client.workspaces.executions.events(\n    execution_id="execution_id",\n    workspace_id="workspace_id",\n)\npage = page.items[0]\nprint(page.at)',
      },
      typescript: {
        method: 'client.workspaces.executions.events',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\n// Automatically fetches more pages as needed.\nfor await (const executionEvent of client.workspaces.executions.events('execution_id', {\n  workspace_id: 'workspace_id',\n})) {\n  console.log(executionEvent.at);\n}",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:terminals list \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id",
      },
      go: {
        method: 'client.Workspaces.Terminals.List',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpage, err := client.Workspaces.Terminals.List(\n\t\tcontext.TODO(),\n\t\t"workspace_id",\n\t\tdedalus.WorkspaceTerminalListParams{},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", page)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/terminals \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.terminals.list',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\npage = client.workspaces.terminals.list(\n    workspace_id="workspace_id",\n)\npage = page.items[0]\nprint(page.terminal_id)',
      },
      typescript: {
        method: 'client.workspaces.terminals.list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:terminals create \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --height 0 \\\n  --width 0",
      },
      go: {
        method: 'client.Workspaces.Terminals.New',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tterminal, err := client.Workspaces.Terminals.New(\n\t\tcontext.TODO(),\n\t\t"workspace_id",\n\t\tdedalus.WorkspaceTerminalNewParams{\n\t\t\tTerminalCreateParams: dedalus.TerminalCreateParams{\n\t\t\t\tHeight: 0,\n\t\t\t\tWidth:  0,\n\t\t\t},\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", terminal.TerminalID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/terminals \\\n    -H \'Content-Type: application/json\' \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY" \\\n    -d \'{\n          "height": 0,\n          "width": 0\n        }\'',
      ...
      python: {
        method: 'workspaces.terminals.create',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\nterminal = client.workspaces.terminals.create(\n    workspace_id="workspace_id",\n    height=0,\n    width=0,\n)\nprint(terminal.terminal_id)',
      },
      typescript: {
        method: 'client.workspaces.terminals.create',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst terminal = await client.workspaces.terminals.create('workspace_id', { height: 0, width: 0 });\n\nconsole.log(terminal.terminal_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:terminals retrieve \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --terminal-id terminal_id",
      },
      go: {
        method: 'client.Workspaces.Terminals.Get',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tterminal, err := client.Workspaces.Terminals.Get(\n\t\tcontext.TODO(),\n\t\t"terminal_id",\n\t\tdedalus.WorkspaceTerminalGetParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", terminal.TerminalID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/terminals/$TERMINAL_ID \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      },
      python: {
        method: 'workspaces.terminals.retrieve',
        example:
          'import os\nfrom dedalus_sdk import Dedalus\n\nclient = Dedalus(\n    api_key=os.environ.get("DEDALUS_API_KEY"),  # This is the default and can be omitted\n)\nterminal = client.workspaces.terminals.retrieve(\n    terminal_id="terminal_id",\n    workspace_id="workspace_id",\n)\nprint(terminal.terminal_id)',
      },
      typescript: {
        method: 'client.workspaces.terminals.retrieve',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst terminal = await client.workspaces.terminals.retrieve('terminal_id', {\n  workspace_id: 'workspace_id',\n});\n\nconsole.log(terminal.terminal_id);",
      },
    },
  },
  {
    ...
    perLanguage: {
      cli: {
        ...
        example:
          "dedalus workspaces:terminals delete \\\n  --api-key 'My API Key' \\\n  --workspace-id workspace_id \\\n  --terminal-id terminal_id",
      },
      go: {
        method: 'client.Workspaces.Terminals.Delete',
        example:
          'package main\n\nimport (\n\t"context"\n\t"fmt"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tterminal, err := client.Workspaces.Terminals.Delete(\n\t\tcontext.TODO(),\n\t\t"terminal_id",\n\t\tdedalus.WorkspaceTerminalDeleteParams{\n\t\t\tWorkspaceID: "workspace_id",\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", terminal.TerminalID)\n}\n',
      },
      http: {
        example:
          'curl https://dcs.dedaluslabs.ai/v1/workspaces/$WORKSPACE_ID/terminals/$TERMINAL_ID \\\n    -X DELETE \\\n    -H "Authorization: Bearer $DEDALUS_API_KEY"',
      ...
      python: {
        method: 'workspaces.terminals.delete',
        example:
      ...
      typescript: {
        method: 'client.workspaces.terminals.delete',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nconst terminal = await client.workspaces.terminals.delete('terminal_id', {\n  workspace_id: 'workspace_id',\n});\n\nconsole.log(terminal.terminal_id);",
      },
    },
  },
  {
    ...
    summary: '',
    description: '',
    stainlessPath: '(resource) workspaces.terminals > (method) connect',
    qualified: 'client.workspaces.terminals.connect',
    perLanguage: {
      cli: {
        example: "dedalus workspaces:terminals connect \\\n  --api-key 'My API Key'",
      },
      go: {
        method: 'client.Workspaces.Terminals.Connect',
        example:
          'package main\n\nimport (\n\t"context"\n\n\t"github.com/dedalus-labs/dedalus-go"\n\t"github.com/dedalus-labs/dedalus-go/option"\n)\n\nfunc main() {\n\tclient := dedalus.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\terr := client.Workspaces.Terminals.Connect(context.TODO())\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n}\n',
      },
      python: {
        method: 'workspaces.terminals.connect',
        example:
      ...
      typescript: {
        method: 'client.workspaces.terminals.connect',
        example:
          "import Dedalus from 'dedalus';\n\nconst client = new Dedalus({\n  apiKey: process.env['DEDALUS_API_KEY'], // This is the default and can be omitted\n});\n\nawait client.workspaces.terminals.connect();",
      },
    },
  },
];
