...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "response": "{ created_at: string; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; status: { last_progress_at: string; last_transition_at: string; phase: string; reason: string; retryable: boolean; revision: string; last_error?: string; }; storage_gib: number; vcpu: number; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; status: { last_progress_at: string; last_transition_at: string; phase: string; reason: string; retryable: boolean; revision: string; last_error?: string; }; storage_gib: number; vcpu: number; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/status/stream \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/sleep \\\n    -X POST \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/wake \\\n    -X POST \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ artifact_id: string; created_at: string; machine_id: string; name: string; size_bytes: number; download_url?: string; execution_id?: string; expires_at?: string; mime_type?: string; sha256?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/artifacts \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:artifacts retrieve \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --artifact-id artifact_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/artifacts/$ARTIFACT_ID \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:artifacts delete \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --artifact-id artifact_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/artifacts/$ARTIFACT_ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
  ...
  },
  {
    ...
    "response": "{ created_at: string; machine_id: string; port: number; preview_id: string; status: 'wake_in_progress' | 'ready' | 'closed' | 'expired' | 'failed'; visibility: 'public' | 'private' | 'org'; error_code?: string; error_message?: string; expires_at?: string; protocol?: 'http' | 'https'; ready_at?: string; retry_after_ms?: number; url?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/previews \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:previews create \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --port 0"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/previews \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\" \\\n    -d '{\n          \"port\": 0\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:previews retrieve \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --preview-id preview_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/previews/$PREVIEW_ID \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:previews delete \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --preview-id preview_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/previews/$PREVIEW_ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/ssh \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "ssh create",
        "example": "dedalus machines:ssh create \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --public-key public_key"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/ssh \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\" \\\n    -d '{\n          \"public_key\": \"public_key\"\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "ssh retrieve",
        "example": "dedalus machines:ssh retrieve \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --session-id session_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/ssh/$SESSION_ID \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "ssh delete",
        "example": "dedalus machines:ssh delete \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --session-id session_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/ssh/$SESSION_ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/executions \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:executions create \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --command string"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/executions \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\" \\\n    -d '{\n          \"command\": [\n            \"string\"\n          ]\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:executions retrieve \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --execution-id execution_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/executions/$EXECUTION_ID \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:executions delete \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --execution-id execution_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/executions/$EXECUTION_ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
  ...
  },
  {
    ...
    "response": "{ execution_id: string; stderr?: string; stderr_bytes?: number; stderr_truncated?: boolean; stdout?: string; stdout_bytes?: number; stdout_truncated?: boolean; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:executions output \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --execution-id execution_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/executions/$EXECUTION_ID/output \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ at: string; sequence: number; type: 'lifecycle' | 'stdout' | 'stderr'; chunk?: string; error_code?: string; error_message?: string; exit_code?: number; signal?: number; status?: 'wake_in_progress' | 'queued' | 'running' | 'succeeded' | 'failed' | 'cancelled' | 'expired'; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:executions events \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --execution-id execution_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/executions/$EXECUTION_ID/events \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ created_at: string; height: number; machine_id: string; status: 'wake_in_progress' | 'ready' | 'closed' | 'expired' | 'failed'; terminal_id: string; width: number; error_code?: string; error_message?: string; expires_at?: string; protocol?: 'websocket'; ready_at?: string; retry_after_ms?: number; stream_url?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/terminals \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:terminals create \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --height 0 \\\n  --width 0"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/terminals \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\" \\\n    -d '{\n          \"height\": 0,\n          \"width\": 0\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:terminals retrieve \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --terminal-id terminal_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/terminals/$TERMINAL_ID \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "dedalus machines:terminals delete \\\n  --api-key 'My API Key' \\\n  --machine-id machine_id \\\n  --terminal-id terminal_id"
      },
      "http": {
        "example": "curl https://dcs.dedaluslabs.ai/v1/machines/$MACHINE_ID/terminals/$TERMINAL_ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $DEDALUS_API_KEY\""
      }
