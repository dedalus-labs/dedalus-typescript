...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    response:
      "{ autosleep_seconds: number; created_at: string; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }",
    markdown:
      "## list\n\n`client.machines.list(cursor?: string, limit?: number): { autosleep_seconds: number; created_at: string; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n**get** `/v1/machines`\n\nList machines\n\n### Parameters\n\n- `cursor?: string`\n\n- `limit?: number`\n\n### Returns\n\n- `{ autosleep_seconds: number; created_at: string; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n  - `autosleep_seconds: number`\n  - `created_at: string`\n  - `desired_state: 'running' | 'sleeping' | 'destroyed'`\n  - `machine_id: string`\n  - `memory_mib: number`\n  - `phase: string`\n  - `storage_gib: number`\n  - `vcpu: number`\n\n### Example\n\n```typescript\nimport Dedalus from 'dedalus';\n\nconst client = new Dedalus();\n\n// Automatically fetches more pages as needed.\nfor await (const machineListItem of client.machines.list()) {\n  console.log(machineListItem);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['autosleep?: string;', 'memory_mib?: number;', 'storage_gib?: number;', 'vcpu?: number;'],
    response:
      "{ autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }",
    markdown:
      "## create\n\n`client.machines.create(autosleep?: string, memory_mib?: number, storage_gib?: number, vcpu?: number): { autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n**post** `/v1/machines`\n\nCreate machine\n\n### Parameters\n\n- `autosleep?: string`\n  Idle window before autosleep. Accepts fixed duration units like 30s, 30m, 2h, 7d3h4s, or 1w3d, raw seconds (\"1800\"), or never to disable.\n\n- `memory_mib?: number`\n  Memory in MiB.\n\n- `storage_gib?: number`\n  Storage in GiB.\n\n- `vcpu?: number`\n  CPU in vCPUs.\n\n### Returns\n\n- `{ autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n  - `autosleep_seconds: number`\n  - `desired_state: 'running' | 'sleeping' | 'destroyed'`\n  - `machine_id: string`\n  - `memory_mib: number`\n  - `phase: string`\n  - `storage_gib: number`\n  - `vcpu: number`\n\n### Example\n\n```typescript\nimport Dedalus from 'dedalus';\n\nconst client = new Dedalus();\n\nconst machine = await client.machines.create();\n\nconsole.log(machine);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'machines.create',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nmachine = dedalus.machines.create\n\nputs(machine)',
      },
      cli: {
        method: 'machines create',
        example: "dedalus machines create \\\n  --api-key 'My API Key'",
      },
      php: {
        method: 'machines->create',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$machine = $client->machines->create(\n  autosleep: 'autosleep', memoryMiB: 1, storageGiB: 1, vcpu: 1\n);\n\nvar_dump($machine);",
      },
      csharp: {
        method: 'Machines.Create',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'machines.retrieve',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nmachine = dedalus.machines.retrieve(machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c")\n\nputs(machine)',
      },
      cli: {
        method: 'machines retrieve',
        example:
  ...
  },
  {
    ...
    response:
      "{ autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }",
    markdown:
      "## update\n\n`client.machines.update(machine_id: string, autosleep?: string, memory_mib?: number, storage_gib?: number, vcpu?: number): { autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n**patch** `/v1/machines/{machine_id}`\n\nUpdate machine\n\n### Parameters\n\n- `machine_id: string`\n\n- `autosleep?: string`\n  Idle window before autosleep. Accepts fixed duration units like 30s, 30m, 2h, 7d3h4s, or 1w3d, raw seconds (\"1800\"), or never to disable.\n\n- `memory_mib?: number`\n  Memory in MiB.\n\n- `storage_gib?: number`\n  Storage in GiB.\n\n- `vcpu?: number`\n  CPU in vCPUs.\n\n### Returns\n\n- `{ autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n  - `autosleep_seconds: number`\n  - `desired_state: 'running' | 'sleeping' | 'destroyed'`\n  - `machine_id: string`\n  - `memory_mib: number`\n  - `phase: string`\n  - `storage_gib: number`\n  - `vcpu: number`\n\n### Example\n\n```typescript\nimport Dedalus from 'dedalus';\n\nconst client = new Dedalus();\n\nconst machine = await client.machines.update({ machine_id: 'dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c' });\n\nconsole.log(machine);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'machines.update',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nmachine = dedalus.machines.update(machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c")\n\nputs(machine)',
      },
      cli: {
        method: 'machines update',
        example:
  ...
  },
  {
    ...
    response:
      "{ autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }",
    markdown:
      "## delete\n\n`client.machines.delete(machine_id: string): { autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n**delete** `/v1/machines/{machine_id}`\n\nDestroy machine\n\n### Parameters\n\n- `machine_id: string`\n\n### Returns\n\n- `{ autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n  - `autosleep_seconds: number`\n  - `desired_state: 'running' | 'sleeping' | 'destroyed'`\n  - `machine_id: string`\n  - `memory_mib: number`\n  - `phase: string`\n  - `storage_gib: number`\n  - `vcpu: number`\n\n### Example\n\n```typescript\nimport Dedalus from 'dedalus';\n\nconst client = new Dedalus();\n\nconst machine = await client.machines.delete({ machine_id: 'dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c' });\n\nconsole.log(machine);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'machines.delete',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nmachine = dedalus.machines.delete(machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c")\n\nputs(machine)',
      },
      cli: {
        method: 'machines delete',
        example:
  ...
  },
  {
    ...
    response:
      "{ autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }",
    markdown:
      "## sleep\n\n`client.machines.sleep(machine_id: string): { autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n**post** `/v1/machines/{machine_id}/sleep`\n\nSleep a running machine\n\n### Parameters\n\n- `machine_id: string`\n\n### Returns\n\n- `{ autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n  - `autosleep_seconds: number`\n  - `desired_state: 'running' | 'sleeping' | 'destroyed'`\n  - `machine_id: string`\n  - `memory_mib: number`\n  - `phase: string`\n  - `storage_gib: number`\n  - `vcpu: number`\n\n### Example\n\n```typescript\nimport Dedalus from 'dedalus';\n\nconst client = new Dedalus();\n\nconst machine = await client.machines.sleep({ machine_id: 'dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c' });\n\nconsole.log(machine);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        ...
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nmachine = dedalus.machines.sleep_(machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c")\n\nputs(machine)',
      },
      cli: {
        method: 'machines sleep',
        example:
  ...
  },
  {
    ...
    response:
      "{ autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }",
    markdown:
      "## wake\n\n`client.machines.wake(machine_id: string): { autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n**post** `/v1/machines/{machine_id}/wake`\n\nWake a sleeping machine\n\n### Parameters\n\n- `machine_id: string`\n\n### Returns\n\n- `{ autosleep_seconds: number; desired_state: 'running' | 'sleeping' | 'destroyed'; machine_id: string; memory_mib: number; phase: string; storage_gib: number; vcpu: number; }`\n\n  - `autosleep_seconds: number`\n  - `desired_state: 'running' | 'sleeping' | 'destroyed'`\n  - `machine_id: string`\n  - `memory_mib: number`\n  - `phase: string`\n  - `storage_gib: number`\n  - `vcpu: number`\n\n### Example\n\n```typescript\nimport Dedalus from 'dedalus';\n\nconst client = new Dedalus();\n\nconst machine = await client.machines.wake({ machine_id: 'dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c' });\n\nconsole.log(machine);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'machines.wake',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nmachine = dedalus.machines.wake(machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c")\n\nputs(machine)',
      },
      cli: {
        method: 'machines wake',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'machines.ssh.list',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\npage = dedalus.machines.ssh.list(machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c")\n\nputs(page)',
      },
      cli: {
        method: 'ssh list',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'machines.ssh.create',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nssh_session = dedalus.machines.ssh.create(\n  machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c",\n  public_key: "public_key"\n)\n\nputs(ssh_session)',
      },
      cli: {
        method: 'ssh create',
        example:
      ...
      php: {
        method: 'machines->ssh->create',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$sshSession = $client->machines->ssh->create(\n  machineID: 'dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c', publicKey: 'public_key'\n);\n\nvar_dump($sshSession);",
      },
      csharp: {
        method: 'Machines.Ssh.Create',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'machines.ssh.retrieve',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nssh_session = dedalus.machines.ssh.retrieve(\n  machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c",\n  session_id: "session_id"\n)\n\nputs(ssh_session)',
      },
      cli: {
        method: 'ssh retrieve',
        example:
      ...
      php: {
        method: 'machines->ssh->retrieve',
        example:
          "<?php\n\nrequire_once dirname(__DIR__) . '/vendor/autoload.php';\n\n$client = new Client(apiKey: 'My API Key');\n\n$sshSession = $client->machines->ssh->retrieve(\n  machineID: 'dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c', sessionID: 'session_id'\n);\n\nvar_dump($sshSession);",
      },
      csharp: {
        method: 'Machines.Ssh.Retrieve',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'machines.ssh.delete',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nssh_session = dedalus.machines.ssh.delete(\n  machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c",\n  session_id: "session_id"\n)\n\nputs(ssh_session)',
      },
      cli: {
        method: 'ssh delete',
        example:
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'machines.executions.list',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\npage = dedalus.machines.executions.list(machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c")\n\nputs(page)',
      },
      cli: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'machines.executions.create',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nexecution = dedalus.machines.executions.create(\n  machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c",\n  command: ["string"]\n)\n\nputs(execution)',
      },
      cli: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'machines.executions.retrieve',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nexecution = dedalus.machines.executions.retrieve(\n  machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c",\n  execution_id: "execution_id"\n)\n\nputs(execution)',
      },
      cli: {
  ...
  },
  {
    ...
    response:
      "{ command: string[]; created_at: string; execution_id: string; machine_id: string; status: 'wake_in_progress' | 'queued' | 'running' | 'succeeded' | 'failed' | 'cancelled' | 'expired'; artifacts?: { artifact_id: string; name: string; }[]; completed_at?: string; cwd?: string; env_keys?: string[]; error_code?: string; error_message?: string; exit_code?: number; expires_at?: string; retry_after_ms?: number; signal?: number; started_at?: string; stderr_bytes?: number; stderr_truncated?: boolean; stdout_bytes?: number; stdout_truncated?: boolean; }",
    markdown:
      "## delete\n\n`client.machines.executions.delete(machine_id: string, execution_id: string): { command: string[]; created_at: string; execution_id: string; machine_id: string; status: 'wake_in_progress' | 'queued' | 'running' | 'succeeded' | 'failed' | 'cancelled' | 'expired'; artifacts?: artifact_ref[]; completed_at?: string; cwd?: string; env_keys?: string[]; error_code?: string; error_message?: string; exit_code?: number; expires_at?: string; retry_after_ms?: number; signal?: number; started_at?: string; stderr_bytes?: number; stderr_truncated?: boolean; stdout_bytes?: number; stdout_truncated?: boolean; }`\n\n**delete** `/v1/machines/{machine_id}/executions/{execution_id}`\n\nDelete execution\n\n### Parameters\n\n- `machine_id: string`\n\n- `execution_id: string`\n\n### Returns\n\n- `{ command: string[]; created_at: string; execution_id: string; machine_id: string; status: 'wake_in_progress' | 'queued' | 'running' | 'succeeded' | 'failed' | 'cancelled' | 'expired'; artifacts?: { artifact_id: string; name: string; }[]; completed_at?: string; cwd?: string; env_keys?: string[]; error_code?: string; error_message?: string; exit_code?: number; expires_at?: string; retry_after_ms?: number; signal?: number; started_at?: string; stderr_bytes?: number; stderr_truncated?: boolean; stdout_bytes?: number; stdout_truncated?: boolean; }`\n\n  - `command: string[]`\n  - `created_at: string`\n  - `execution_id: string`\n  - `machine_id: string`\n  - `status: 'wake_in_progress' | 'queued' | 'running' | 'succeeded' | 'failed' | 'cancelled' | 'expired'`\n  - `artifacts?: { artifact_id: string; name: string; }[]`\n  - `completed_at?: string`\n  - `cwd?: string`\n  - `env_keys?: string[]`\n  - `error_code?: string`\n  - `error_message?: string`\n  - `exit_code?: number`\n  - `expires_at?: string`\n  - `retry_after_ms?: number`\n  - `signal?: number`\n  - `started_at?: string`\n  - `stderr_bytes?: number`\n  - `stderr_truncated?: boolean`\n  - `stdout_bytes?: number`\n  - `stdout_truncated?: boolean`\n\n### Example\n\n```typescript\nimport Dedalus from 'dedalus';\n\nconst client = new Dedalus();\n\nconst execution = await client.machines.executions.delete({ machine_id: 'dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c', execution_id: 'execution_id' });\n\nconsole.log(execution);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'machines.executions.delete',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nexecution = dedalus.machines.executions.delete(\n  machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c",\n  execution_id: "execution_id"\n)\n\nputs(execution)',
      },
      cli: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'machines.executions.output',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\nexecution_output = dedalus.machines.executions.output(\n  machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c",\n  execution_id: "execution_id"\n)\n\nputs(execution_output)',
      },
      cli: {
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'machines.executions.events',
        example:
          'require "dedalus"\n\ndedalus = Dedalus::Client.new(api_key: "My API Key")\n\npage = dedalus.machines.executions.events(\n  machine_id: "dm-ecc2efdd-ddfa-31a9-c6f1-b833d337aa7c",\n  execution_id: "execution_id"\n)\n\nputs(page)',
      },
      cli: {
