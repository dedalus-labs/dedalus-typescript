...
import { Dedalus, ClientOptions } from 'dedalus';
...
const fuse = new Fuse(
  [
    ...
    'client.workspaces.artifacts.delete',
    'client.workspaces.artifacts.list',
    'client.workspaces.artifacts.retrieve',
    'client.workspaces.previews.create',
    'client.workspaces.previews.delete',
    'client.workspaces.previews.list',
    'client.workspaces.previews.retrieve',
    'client.workspaces.ssh.create',
    'client.workspaces.ssh.delete',
    'client.workspaces.ssh.list',
    'client.workspaces.ssh.retrieve',
    'client.workspaces.executions.create',
    'client.workspaces.executions.delete',
    'client.workspaces.executions.events',
    ...
    'client.workspaces.terminals.retrieve',
  ],
