...
import { CreateParams, LifecycleStatus, Machine, MachineCreateParams, MachineDeleteParams, MachineList, MachineListItem, MachineListItemsCursorPage, MachineListParams, MachineRetrieveParams, MachineSleepParams, MachineUpdateParams, MachineWakeParams, MachineWatchParams, Machines, UpdateParams } from './resources/machines/machines';
...
export class Dedalus {
  ...
  protected validateHeaders({ values, nulls }: NullableHeaders) {
    ...
    throw new Error('Could not resolve authentication method. Expected either xAPIKey or apiKey to be set. Or for one of the "x-api-key" or "Authorization" headers to be explicitly omitted')
  }
