...
describe('resource ssh', () => {
  test('create: only required params', async () => {
    const responsePromise = client.machines.ssh.create({ machine_id: 'machine_id', public_key: 'public_key' });
  ...
  test('retrieve: only required params', async () => {
    const responsePromise = client.machines.ssh.retrieve({ machine_id: 'machine_id', session_id: 'session_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('retrieve: required and optional params', async () => {
    const response = await client.machines.ssh.retrieve({ machine_id: 'machine_id', session_id: 'session_id' });
  });
  ...
  test('delete: only required params', async () => {
    const responsePromise = client.machines.ssh.delete({ machine_id: 'machine_id', session_id: 'session_id' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
